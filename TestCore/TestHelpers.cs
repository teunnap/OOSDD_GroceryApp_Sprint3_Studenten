...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        public void TestPasswordHelperReturnsFalse()
        {
            ...
            string differentPassword = "wrong";
            string validHash = "sxnIcZdYt8wC8MYWcQVQjQ==.FKd5Z/jwxPv3a63lX+uvQ0+P7EuNYZybvkmdhbnkIHA=";

            Assert.IsFalse(PasswordHelper.VerifyPassword(differentPassword, validHash));
            Assert.Throws<FormatException>(() => PasswordHelper.VerifyPassword(correctPassword, "invalid.format.hash"));
        }
